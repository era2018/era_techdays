...
public class SpoofFenderBender {
    public static void main(String[] args) {
        try {
        	...
        	String testInsert = "INSERT INTO eventLog (eventID, carID, logTime) VALUES (3, '243c201f7957', ADDTIME(HOUR, 4, NOW()))";
        	PreparedStatement ps = connection.prepareStatement(testInsert);
        	ps.execute();
        	testInsert = "INSERT INTO eventLog (eventID, carID, logTime) VALUES (3, 'Spoof', ADDTIME(HOUR, 4, NOW()))";

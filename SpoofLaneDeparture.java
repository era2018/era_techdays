...
public class SpoofLaneDeparture {
    public static void main(String[] args) {
        try {
        	...
        	String testInsert = "INSERT INTO eventLog (eventID, carID, logTime) VALUES (1, '243c201f7957', NOW())";
        	PreparedStatement ps = connection.prepareStatement(testInsert);
        	ps.execute();
        	testInsert = "INSERT INTO eventLog (eventID, carID, logTime) VALUES (1, 'Spoof', NOW())";
